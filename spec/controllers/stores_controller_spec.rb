...
describe StoresController do
  ...
  let(:valid_attributes) { { "idStore" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved store as @store" do
        ...
        post :create, {:store => { "idStore" => "invalid value" }}, valid_session
        assigns(:store).should be_a_new(Store)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested store" do
        ...
        Store.any_instance.should_receive(:update).with({ "idStore" => "1" })
        put :update, {:id => store.to_param, :store => { "idStore" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the store as @store" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Store.any_instance.stub(:save).and_return(false)
        put :update, {:id => store.to_param, :store => { "idStore" => "invalid value" }}, valid_session
        assigns(:store).should eq(store)
      end
